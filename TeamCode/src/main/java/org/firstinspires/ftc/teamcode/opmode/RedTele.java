...
//
//        if (Robot.endPose == null) {
//            r.f.setStartingPose(r.a.equals(Alliance.RED) ? Robot.defaultPose.mirror() : Robot.defaultPose);
//        } else {
...
//        if (!hold)
//            if (field)
//                r.f.setTeleOpDrive(-gamepad1.left_stick_y, -gamepad1.left_stick_x, shoot ? -gamepad1.right_stick_x * 0.5 : -gamepad1.right_stick_x * 0.75, false, r.a == Alliance.RED ? Math.toRadians(180) : 0);
//            else
