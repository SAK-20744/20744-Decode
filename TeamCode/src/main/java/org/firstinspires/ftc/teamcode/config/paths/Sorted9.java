...
public class Sorted9 {
    ...
    public Pose intake2Control = FieldPoses.redBall0Ctrl2;
    public Pose intake2Control2 = FieldPoses.redBall0Ctrl;
    ...
    public Sorted9(Robot r) {
        ...
        if (r.a.equals(Alliance.BLUE)) {
            ...
            intake2Control2 = mirror(intake2Control2);
...
//                        )
//                )
//                .setLinearHeadingInterpolation(gateOpen.getHeading(), intake2Control.getHeading(), 0.3)
//                .setBrakingStrength(intakeBreakStrength)
//                .addPath(
//                        new BezierCurve(
//                                intake2Control,
...
//                        )
//                )
//                .setLinearHeadingInterpolation(intake2Control.getHeading(), intake2.getHeading(), 0.3)
//                .setBrakingStrength(intakeBreakStrength)
//                .build();
//    }
    public PathChain intake2() {
