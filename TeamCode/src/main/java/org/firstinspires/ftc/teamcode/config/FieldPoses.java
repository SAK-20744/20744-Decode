...
public class FieldPoses {
    ...
    public static Pose blueStartPos = mirror(redFarStart);

    public static Pose redHPPickup = new Pose(redFarStart.getX(), TS*3-BOT_LENGTH/2);
    public static Pose blueHPPickup = mirror(redHPPickup);
    ...
    public static Pose mirror(Pose pose) {return new Pose(pose.getX(), -pose.getY(), -pose.getHeading());}
}
